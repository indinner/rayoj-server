...
def ray_oj(data):
    ...
    for i in range(0, len(input_case)):  # 创建测试用例文件
        ...
        if language == 'python':
            ...
            language_type = 'cpp'
        cmd = "python /home/acm-judge-module/judge/judge.py --language " + language_type + " --languageConfig /home/acm-judge-module/judge/language/ --file /testcase/" + random_id + "/" + "Main" + " --time " + str(
            time) + " --memory " + str(
